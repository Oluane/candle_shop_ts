			...
			<section className="ourValuesWrapper">
				...
				<div className="ourValuesContent">
					...
					<p className="valuesDesc usualText alignJustify">
						Ice cream cotton candy apple pie gummies pudding I love pudding. Wafer oat
						cake I love dessert sweet liquorice. Oat cake bear claw croissant cupcake
						sweet roll. Tootsie roll tart I love danish apple pie I love. Dessert
						cupcake marshmallow. Dragée candy caramels tootsie roll jelly-o carrot cake.
					</p>
					<div className="valuesList">
						<div className="valuesRow">
							...
							<div className="valuesText">
								<p className="mediumText uppercase mediumBold valuesTitle">
									Hello sweetie !
								</p>
								<p className="mediumText">
									Mama mia que calor, Mama mia que calor!
								</p>
							</div>
						</div>
						<div className="valuesRow">

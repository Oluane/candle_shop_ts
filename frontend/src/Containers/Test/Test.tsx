  ...
  return (
    <div className="testWrapper">
      ...
      <div className="colorsWrapper">
        ...
        <div className="previewNameWrapper">
          <div className="testColor" style={{ backgroundColor: "rgba(244, 240, 238, 0.8)" }}></div>
          <p>
        ...
        <div className="previewNameWrapper">
          <div className="testColor" style={{ backgroundColor: "rgba(186, 165, 141, 0.95)" }}></div>
          <p>
            tertiaryTrans <br />
        ...
        <div className="previewNameWrapper">
          <div className="testColor" style={{ backgroundColor: "rgba(35, 35, 35, 0.5)" }}></div>
          <p>
            lightGrey <br />
            rgba(35, 35, 35, 0.5)
          </p>
        ...
        <div className="previewNameWrapper">
          <div className="testColor" style={{ backgroundColor: "rgba(35, 35, 35, 0.1)" }}></div>
          <p>
            lightGreyTrans <br />
            rgba(35, 35, 35, 0.1)
          </p>
        ...
        <div className="previewNameWrapper">
          <div className="testColor" style={{ backgroundColor: "rgba(212, 158, 141, 0.9)" }}></div>
          <p>
            roseGoldTrans <br />

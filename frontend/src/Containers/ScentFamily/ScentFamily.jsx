      ...
      {!isLoading ? (
        <>
          <header className="familyHeader">
            ...
            <div className="familyDesc usualText alignJustify">{currentFamily.enDesc}</div>
          </header>
          ...
          <section className="scentWrapper bgSecondary">
            ...
            <div className="scrollWrapper">
                  ...
                  scents.map((scent, i) => {
                    return (
                      <React.Fragment key={"scentItem" + i}>
                        <div
                          className={"scentItem " + (selectedScent.id === scent.id ? "active" : "")}
                        ...
                        {i < scents.length - 1 && <div className="separation"></div>}
                      </React.Fragment>
                    );
                  })}
              </div>
              {scrollIndex > 0 && deviceWidth > 688 && (
                <div className="leftArrowContainer" onClick={() => scrollToNextElements("left")}>
              ...
              {!isScrollMax && deviceWidth > 688 && (
                <div className="rightArrowContainer" onClick={() => scrollToNextElements("right")}>
                  <div className="directionArrow">
            ...
            <div className="scentInfoWrapper">
              ...
              <div className="scentComplementary">
                <ul className="mediumText complementaryList">
                  <li>{selectedScent.isEssentialOil ? "With essential oils" : "No essential oils"}</li>
                      ...
                      {candleTypes.map((type, i) => {
                        return (
                          ...
                          >
                            ...
                            <p className="usualText alignCenter">{type.enName}</p>
                          </Link>
                        );
                      })}
                    </div>
        ...
        <>
          <header className="familyHeader">
            <SkeletonItem style={{ width: "100%", height: "330px", backgroundColor: "#cecece" }} />
            <SkeletonItem
              style={{
                width: "200px",
                height: "38px",
            ...
            />
            <SkeletonItem style={{ width: "100%", height: "415px", backgroundColor: "#cecece" }} />
          </header>
        </>
      )}
    </div>

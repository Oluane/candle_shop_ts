...
const NavbarMobile = ({ isLoggedUser }: NavbarMobileProps) => {
  ...
  return (
    <>
      <div className="burgerIconWrapper" onClick={() => setToggleSideMenuDisplay(!toggleSideMenuDisplay)}>
        <IconSvg iconName={!toggleSideMenuDisplay ? "burgerMenu" : "closeCross"} />
      </div>
      <ShoppingCart />
      <div className={"sideMenu" + (toggleSideMenuDisplay ? " active" : "")} style={{ height: deviceHeight }}>
        <ul className="listMenu largeText">
          ...
          <li>
            <Link to="/candles" className="listRow" onClick={() => setToggleSideMenuDisplay(!toggleSideMenuDisplay)}>
              <h4>CANDLES</h4>
              <div className="navArrow">
                <IconSvg iconName="rightArrow" />
              </div>
          ...
          <li>
            <Link to="/about_us" className="listRow" onClick={() => setToggleSideMenuDisplay(!toggleSideMenuDisplay)}>
              <h4>ABOUT US</h4>
              <div className="navArrow">
                <IconSvg iconName="rightArrow" />
              </div>

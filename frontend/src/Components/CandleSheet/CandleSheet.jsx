...
const requiredSlideImg = require.context("../../../public/images/candle_types", false, /\.(png|jpe?g|svg)$/);

const CandleSheet = ({ types, selectedType, setSelectedType, selectedScentId, setSelectedScentId }) => {
      ...
      {typeSizes && selectedTypeSize && (
        <div className="candleSheetInfoWrapper">
          ...
          <div className="candleInfoContainer mediumText">
            ...
            {selectedScentId && selectedScent && <p className="separatorBefore">{selectedScent.enName}</p>}
          </div>
          <div className="candleVariantsWrapper">
            <div className="variantsOptionsContainer usualText">
              <div className="variantsOptions">
                ...
                <div className="variantsValues">
                  {types.map((type, i) => {
                    return (
                      <div
                        className={"typeIcon" + (type.id === selectedType ? " active" : "")}
                    ...
                    return (
                      <div
                        className={
                          ...
                          (size.typeSizeId === selectedTypeSize.typeSizeId ? " active" : "")
                        }
              ...
              <div className="variantsOptions">
                ...
                <div className="selectorCustom" onClick={() => setShowDropdown(true)}>
                  <span className="selectorCustomValue">
                    {selectedScentId !== null && selectedScent ? selectedScent.enName : "Select"}
                  </span>
          ...
          <div className="actionsBtnWrapper">
            <AddToCartBtn btnType="text" typeSize={selectedTypeSize} scent={selectedScent} />

...
const ShoppingCartItem = ({ product, isCheckout }) => {
  ...
  const { candleId, typeId, typeEnName, sizeEnName, scentsEnName, price, quantity, isAvailable } = product;
  ...
  return (
    <div className={"productRow" + (isCheckout ? " checkoutDisplay" : "")} key={"candleCart" + candleId}>
      <div className="productImg">
        <img src={`/images/candle_types/candle_type_${typeId}_1.jpg`} alt={`${typeEnName} candles`} />
      </div>
